...
namespace Notify.Helpers
{
    public static class Constants
    {
        ...
        public static readonly string AZURE_FUNCTIONS_PATTERN_NOTIFICATION_TIME = $"{AZURE_FUNCTIONS_PATTERN_NOTIFICATION_CREATION}/time";
        public static readonly string AZURE_FUNCTIONS_PATTERN_NOTIFICATION_LOCATION = $"{AZURE_FUNCTIONS_PATTERN_NOTIFICATION_CREATION}/location";
        public static readonly string AZURE_FUNCTIONS_PATTERN_NOTIFICATION_DYNAMIC = $"{AZURE_FUNCTIONS_PATTERN_NOTIFICATION_CREATION}/dynamic";
